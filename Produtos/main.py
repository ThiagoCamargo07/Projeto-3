...
# bibliotecas a instalar: 
    ...
    # Simple Websocket – pip install simple-websocket / pip install flask-socketio
...
app.config["SECRET"] = "THI070404" # chave de seguranca, pode ser qualquer coisa, mas escolha algo dificil
